...
List<DesignInfo> config = [
  ...
  DesignInfo(
      ...
      '''APIs should support simple LISPy functional programming constructs. Let your users fetch just the data they want in the form they want by applying <i>map</i>, <i>fold</i> and such <i>in the back end</i> makes your aPI si mpler and more expressive while reducing the load on the back end.<br>Yes, there are security implications, and yes, we might want to avoid making this Turing complete, but these problems are both surmountable.''',
  ),
  DesignInfo(
    'First, there is the data',
    '''Code, apps, everything comes and goes and changes, except the data.<br>There is nothing you can do in software design that is more enduring, flexible and simple than a good, normalized relational data design. Everything after that is a denormalization. Including the user interface.<br>Software architecture always circles this idea. The latest example is the popularity of <link href="https://en.wikipedia.org/wiki/Functional_reactive_programming">Functional Reactive Programming</link>.'''
  ),
  DesignInfo(
